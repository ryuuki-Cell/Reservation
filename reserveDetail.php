 ...
 <section>
    ...
    <form method="post" action="reserveCheck.php" >
      <table class="input">
        ...
        <tr>
          <th>連絡先電話番号（※）</th>
          <td><input type="text" name="dtelno" value="" /><?php echo $dtelno; ?><?php echo $dtelnoErr; ?></td></tr>
        <tr>
          <th>メールアドレス</th>
    ...
    <h3>予約詳細情報</h3>
      <table class="input">
        <tr>
          <th>宿泊人数（※）</th>
        <td><input type="text" name="reserveNumber" value="" /><?php echo $reserveNumErr; ?><?php echo $reserveNum; ?></td>
        </tr>
        <tr>
          <th>チェックイン予定時間（※）</th>
        ...
        <tr>
          <th>連絡事項</th><td><textarea name="message" cols="40" rows="4"></textarea><?php echo $message; ?></td>
        </tr>
      </table><br />
